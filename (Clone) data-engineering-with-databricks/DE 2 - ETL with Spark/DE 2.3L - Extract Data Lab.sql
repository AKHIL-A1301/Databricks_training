...
create external table events_json (key binary, offset bigint, partition integer , timestamp bigint , topic string , value binary)  using json   Location '${DA.paths.kafka_events}'
